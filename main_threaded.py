...
def execute_user_query(queue: list[str]):
    ...
    while True:
        ...
        while True:
            ...
            if len(queue) > 0:
                print("interrupting execution - new query received")
                break
...
if __name__ == "__main__":
    ...
    queue = []
    t = threading.Thread(target=execute_user_query, args=(queue,))
    t.start()
